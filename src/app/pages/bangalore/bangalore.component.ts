...
import { FilterService } from '../../services/filter.service'; // Ensure FilterService is imported

@Component({
  selector: 'app-bangalore',
  standalone: true, // This was missing in your provided snippet, but assumed from context
  imports: [
    RightPanelComponent,
    TopButtonsComponent,
    CommonModule,
